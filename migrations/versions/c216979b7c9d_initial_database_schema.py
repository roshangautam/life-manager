...
def upgrade() -> None:
    ...
    with op.batch_alter_table('households', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_households_created_by', 'users', ['created_by'], ['id'])
    
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_users_household', 'households', ['household_id'], ['id'])

    op.create_table('categories',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('household_id', sa.Integer(), nullable=True),
    sa.Column('type', sa.Enum('EXPENSE', 'INCOME', name='transactiontype'), nullable=True),
    ...
    with op.batch_alter_table('household_invitations', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_household_invitations_id'), ['id'], unique=False)
