...
from api.schemas.user import UserCreate, UserUpdate, User as UserSchema
from api.core.security import verify_password, create_access_token, get_password_hash
...
class UserService(user_pb2_grpc.UserServiceServicer, BaseGRPCService):
    ...
    def CreateUser(self, request, context):
        ...
        try:
            ...
            context.send_initial_metadata((('authorization', f'Bearer {access_token}'),))
